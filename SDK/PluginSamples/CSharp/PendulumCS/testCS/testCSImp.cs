...
namespace testCS
{
    ...
    [Guid("5d94a3a8-380d-48e7-aa09-a4edf4ae93a6")]

    public class testCSImp : EurekaSim.Net.Addin,
        ...
        IFileSettingsTreeViewEvents
    {
        ...
        public void Initialize(int lSessionID, MainApplication pApp, object bFirstTime)
        {
            ...
            Stream rgbxml = thisAssembly.GetManifestResourceStream("testCS.AddinRibbon.xml");

            Stream rgbBmp = thisAssembly.GetManifestResourceStream("testCS.toolbar1.bmp");

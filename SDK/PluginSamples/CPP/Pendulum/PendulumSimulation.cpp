...
BOOL CPendulumSimulation::LoadLongResource(CString &str, UINT nID)
{
	try
	{
		HRSRC               hRes;
...
STDMETHODIMP CPendulumSimulation::InvokePreferenceSettings()
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());

	AfxMessageBox(_T("CPendulumSimulation::InvokePreferenceSettings()"));

	return S_OK;
}


STDMETHODIMP CPendulumSimulation::InvokeDefaultSettings()
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());

	AfxMessageBox(_T("CPendulumSimulation::InvokeDefaultSettings(Hai)"));

	return S_OK;
}


STDMETHODIMP CPendulumSimulation::InvokeOnExperimentChanged()
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	return S_OK;
...
void CPendulumSimulation::SetRibbonControlText(CString ID, CString Text)
{
...
void CPendulumSimulation::LoadAddinName(CString strXML)
{
	try
	{
		USES_CONVERSION;

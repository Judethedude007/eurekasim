...
#define CPP_SAMPLE_MAIN_EXPERIMENT_NAME								_T("Pendulum Experiment Simulation Demo")
...
public:
	...
	CAddinSimulationManager(CPendulumSimulation* pAddin);

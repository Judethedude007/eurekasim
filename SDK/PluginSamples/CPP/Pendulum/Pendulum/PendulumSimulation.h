...
class ATL_NO_VTABLE CPendulumSimulation :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CPendulumSimulation, &CLSID_PendulumSimulation>,
	public IDispatchImpl<IPendulumSimulation, &IID_IPendulumSimulation, &LIBID_PendulumLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
...
public:
	...
	BEGIN_COM_MAP(CPendulumSimulation)
		COM_INTERFACE_ENTRY(IPendulumSimulation)
		COM_INTERFACE_ENTRY2(IDispatch, IPendulumSimulation)
...
OBJECT_ENTRY_AUTO(__uuidof(PendulumSimulation), CPendulumSimulation)

...
#define OBJECT_TYPES								_T("Pendulum")
#define OBJECT_TYPE_PENDULUM						_T("Pendulum")

#define OBJECT_PATTERN_TYPES						_T("Rotate,Random Movement,Oscillate")
#define OBJECT_PATTERN_TYPE_ROTATE					_T("Rotate")
#define OBJECT_PATTERN_TYPE_RANDOM					_T("Random Movement")
#define OBJECT_PATTERN_TYPE_OSCILLATE			    _T("Oscillate")
...
{
	float m_fOscillationAngle; // Add this

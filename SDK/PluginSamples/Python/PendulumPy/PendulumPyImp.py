...
#   PendulumPyImp.py --unregister
#
# To debug, execute:
#   PendulumPyImp.py --debug
#
...
class PendulumPyImp():
    ...
    _reg_clsid_ = "{d6f0576e-798b-432b-a2ef-abf02ffd59c1}"
    _reg_progid_ = "PendulumPyImp"
...
if __name__ == '__main__':
    ...
    win32com.server.register.UseCommandLine(PendulumPyImp)
    if "--unregister" in sys.argv:
        UnregisterAddin(PendulumPyImp)
    else:
        RegisterAddin(PendulumPyImp)
=======
#
# To unregister completely:
#   PendulumPyImp.py --unregister
